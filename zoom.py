...
tt=tt+'/qw.jpg'
path = tt  # place path to your image here
app = MainWindow(tk.Tk(), path=path)
'''
def motion(event):
    global xx
    global yy
    xx, yy = event.x, event.y
    label2 = tk.Label(app.master, text=f" X:{xx} ,Y:{yy} ")
...
def get_pos(self, event):
        ...
        col = (x - xa) // scale
        row = (y - ya) // scale
        label2 = tk.Label(app.master, text=f" X:{col} ,Y:{row} ")
        label2.grid(row=1, column=1)
'''
